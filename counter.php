<?php
if('counter.php' == basename($_SERVER['SCRIPT_FILENAME'])){
    header('../index');
    exit();
}
$expire = 600;
...
mb_internal_encoding('UTF-8');
    ...
    echo '<span class="list-group-item">کاربران آنلاین: '.$online.'</span>';
    echo '<span class="list-group-item">بازدید امروز: '.$day.'</span>';
   echo '<span class="list-group-item">بازدید هفته: '.$week.'</span>';
   echo '<span class="list-group-item">بازدید ماه: '.$month.'</span>';
   echo '<span class="list-group-item">بازدید سال: '.$year.'</span>';
   echo '<span class="list-group-item">کل بازدید: '.$all.'</span>';
   echo '</div>';
}
?>